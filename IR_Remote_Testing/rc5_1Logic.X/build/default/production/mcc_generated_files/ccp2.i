...
uint16_t TimerBuff[50],LevelBuff[50],TimerValue=0,kl=0,data=0;
...
void CCP2_CaptureISR(void)
{
    ...
    if( data==0)
    {
        if(kl<50)
        {
            TimerBuff[kl++]=TimerValue;
            LevelBuff[kl]=PORTCbits.RC7;
        }
        else
        {
            PIR4bits.TMR2IF = 1;
